                                        ...
                                        <>
                                            ...
                                            >
                                                ...
                                                <div
                                                    style={{
                                                        height: "2px",
                                                        width: `calc(${protocolForumPost?.timeline?.percentProgress}% - 10px)`,
                                                        backgroundColor:
                                                            protocolForumPost
                                                                ?.timeline
                                                                ?.primaryColor,
                                                ...
                                                <div
                                                    style={{
                                                        ...
                                                        backgroundColor: "#fff",
                                                        boxShadow:
                                                            "0px 4px 21.8px 0px rgba(0,0,0,0.75)",
                                                    }}
                                                />
                                                <div
                                                    style={{
                                                        width: `calc(${100 - protocolForumPost?.timeline?.percentProgress}% - 20px)`,
                                                        height: "2px",
                                                        border: "none",
                                                        borderTop: `1px dashed ${protocolForumPost?.timeline?.secondaryColor}`,
                                                    }}
                                                />{" "}
                                                <div
                                                    style={{
                                            ...
                                            >
                                                ...
                                                <p
                                                    style={{
                                                        fontSize: "12px",
                                                        color: "#A2A2AE",
                                                        marginLeft: `calc(${protocolForumPost?.timeline?.percentProgress}% - 30px)`,
                                                    }}
                                                >
                                                    Today
                                                </p>
                                                <p
                                                    style={{
                                                        fontSize: "12px",
                                                        color: "#A2A2AE",
                                                        marginLeft: `calc(${100 - protocolForumPost?.timeline?.percentProgress}% - 35px)`,
                                                    }}
                                                >
                                                    {
                                                        protocolForumPost
